...
/***/ function(module, exports) {
	...
	module.exports = {
		"resume_title": "李一奇 - 个人简历",
		"name": "李一奇",
		"job_intension": "前端工程师 / 软件工程师",
		"contact": {
			"phone": "18819431152",
			"email": "liyiqi1996@gmail.com",
			"wechat": {
				"id": "SYSU_017",
			...
			"schools": [
				{
					...
					"end": "2017 年 6 月",
					"honors": [
						"2013 - 2014 学年度校**三等奖学金**",
						"2013 - 2014 外研杯**全国英语写作大赛二等奖**",
						"2014 - 2015 学年度校**三等奖学金**"
					]
				}
			]
		},
		"language": {
			...
			"description": [
				"能流畅阅读英文专业书籍、文档及其他资料",
				"可无字幕观看技术类课程、开发者大会视频",
				"能够在 Github、 Stack Overflow 等社区正常交流"
			]
		},
		"experience": {
			"title": "项目与工作经历",
			"works": [
				{
					...
					"end": "2015.09",
					"description": [
						"使用模块模式开发安卓版-PP助手页面抽奖功能",
						"解决原模块遗留的bug，解耦合各个小模块并完成逻辑上的优化",
						"使用 `Canvas` / `artTemplate` 开发移动端响应式页面"
					]
				},
				{
					"name": "大学城微电商系统",
					...
					"end": "",
					"description": [
						"与他人合作完成的大学城外卖系统平台 ,独立完成电商后台管理的前端页面",
						"基于 `jQuery` 与 `Bootstrap`， 利用 `Ajax` 实现前端组件及数据交互"
					]
				},
				{
					"name": "作业评测系统",
				...
				},
				{
					...
					"description": [
						...
						"使用 `WebPack` 加载模块， `Gulp` 驱动工作流，`Web Worker` 优化图像处理效率"
					]
				}
			]
		},
		"skills": {
			...
			"description": [
				...
				"了解 `WebGL` / `Three.js`，对数字图像处理感兴趣，能实现较复杂的3D图形程序",
				"能够使用 `Node.js API` / `Express` / `Tornado` 搭建简单的后端程序，了解异步 I/O 及事件驱动的服务器模型，掌握常见的异步编程解决方案",
				"熟悉 `Python`，能实现简单的数据及图像处理工具、自动化脚本、爬虫、机器学习算法及分布式程序"
			]
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<li><dl><dt>" + (jade.escape(null == (jade_interp = school.name) ? "" : jade_interp)) + "</dt><dd class=\"clock\">" + (jade.escape(null == (jade_interp = school.start + " ~ " + school.end) ? "" : jade_interp)) + "</dd><dd class=\"major\">" + (jade.escape(null == (jade_interp = school.major) ? "" : jade_interp)) + "</dd>");
