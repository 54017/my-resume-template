			...
			"works": [
				{
					...
					"description": [
						"参与跟进微信公众平台和开放平台的需求",
						"设计实验探究浏览器渲染机制和缓存策略，总结前端最佳实践",
						"研究 `Google Accelerated Mobile Pages Project`，尝试使用其中的一些规范和方法优化性能，提高公众号图文消息用户体验",
						"使用 `Flux` / `NW.js` 开发 `微信小程序(应用号)` 开发者工具",
						"为内部前端构建系统编写 `Gulp` 插件，对开源项目 `vConsole` 有微小的贡献"
					]
				},
				{
